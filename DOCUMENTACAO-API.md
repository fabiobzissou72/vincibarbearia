...
curl https://vincebarbearia.vercel.app/api/lembretes?tipo=amanha

# Buscar lembretes de hoje
curl https://vincebarbearia.vercel.app/api/lembretes?tipo=hoje

# Buscar lembretes de 1 hora antes
curl https://vincebarbearia.vercel.app/api/lembretes?tipo=1hora
```

**Configuração N8N Cron:**
```
Schedule: 0 18 * * * (todo dia às 18h para "amanha")
URL: GET https://vincebarbearia.vercel.app/api/lembretes?tipo=amanha
...
2. **HTTP Request:**
   - Method: `GET`
   - URL: `https://vincebarbearia.vercel.app/api/lembretes?tipo=amanha`
   - Authentication: `None`
